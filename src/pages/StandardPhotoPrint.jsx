  ...
  const features = [
    {
      ...
      description:
        "Professional-grade silver halide photo paper for stunning clarity",
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      title: "Fast Delivery",
      description:
        "Express shipping available - receive prints within 3-5 days",
    },
    {
      icon: Sparkles,
      ...
      <div className="relative pt-24 pb-12 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <span
              onClick={() => navigate("/")}
              className="hover:text-[#E6C2A1] cursor-pointer transition-colors"
            >
              Home
            </span>
            <span>/</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-6">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  Our premium photo prints use professional silver halide photo
                  paper with emulsion printing technology. Each print is
                  carefully crafted to preserve the vibrant colors and fine
                  details of your memories. Choose from multiple sizes and
                  finishes to create the perfect display for your space.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-1">
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                      className="w-5 h-5 fill-[#E6C2A1] text-[#E6C2A1]"
                    />
                  ))}
                </div>
                <span className="text-gray-400 text-sm">
                  4.9 out of 5 (1,084 reviews)
                </span>
              </div>
              ...
              <div className="bg-gradient-to-br from-[#E6C2A1]/10 to-transparent border border-[#E6C2A1]/20 rounded-xl p-6">
                ...
                <div className="flex items-baseline gap-3 mb-2">
                  <span className="text-4xl font-bold text-[#E6C2A1]">
                    AED {pricePerImage}
                  </span>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    {sizes.map((size) => (
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className={`
          relative px-2 sm:px-4 py-2 sm:py-3 rounded-lg font-medium transition-all
          text-xs sm:text-sm
          ${
            selectedSize === size
              ...
              >
                <div className="flex items-center gap-1 mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star
                      key={i}
                      className="w-4 h-4 fill-[#E6C2A1] text-[#E6C2A1]"
                    />
                  ))}
                </div>
                ...
                <p className="text-[#E6C2A1] font-semibold">
                  {testimonial.name}
                </p>
              </motion.div>
            ))}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-gray-300 text-lg leading-relaxed max-w-2xl mx-auto">
              We stand behind the quality of every print. If you're not
              completely satisfied with your order, we'll reprint it for free or
